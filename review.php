...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nama === '' || $rating < 1 || $rating > 5 || $komentar === '') {
        ...
        $insert = "INSERT INTO ulasan (nama_pengunjung, rating, komentar) 
                   VALUES ('$nama', '$rating', '$komentar')";
...
<section class="hero-section">
    <div class="container">
        ...
        <p class="hero-text">
            Lihat pengalaman pengunjung lain dan bagikan kesanmu setelah berkunjung ke Samarinda Theme Park.
        </p>
    </div>
</section>
                ...
                <div class="review-form-card">
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="komentar" rows="5" class="form-control" placeholder="Tulis ulasan kamu..." required></textarea>
                        </div>
