...
// BUNDLE TIKET (AMBIL DARI TABEL PROMO)
...
<section class="hero" style="background-image: url('assets/img/<?= !empty($beranda['hero_background']) ? htmlspecialchars($beranda['hero_background']) : 'hero.jpg'; ?>');">
    ...
    <div class="container">
        ...
        <div class="location-grid">
            <div class="location-map-card">
                <img src="assets/img/lokasi-stp.jpg" alt="Lokasi Samarinda Theme Park">
            </div>
                ...
                <?php while ($wahana = mysqli_fetch_assoc($qWahana)): ?>
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img src="assets/img/<?= !empty($wahana['gambar']) ? htmlspecialchars($wahana['gambar']) : 'default.jpg'; ?>" alt="<?= htmlspecialchars($wahana['nama_wahana']); ?>">
                        </div>
                        <div class="card-body">
                            ...
                            <span class="level-badge <?= $warnaLevel; ?>">
            ...
            <?php if ($qFasilitas && mysqli_num_rows($qFasilitas) > 0): ?>
                <?php while ($fasilitas = mysqli_fetch_assoc($qFasilitas)): ?>
                    <div class="facility-card">
                        ...
                        <span class="facility-meta"><?= htmlspecialchars($fasilitas['lokasi']); ?></span>
                    </div>
                <?php endwhile; ?>
            <?php else: ?>
            ...
            <?php if ($qTiket && mysqli_num_rows($qTiket) > 0): ?>
                <?php while ($tiket = mysqli_fetch_assoc($qTiket)): ?>
                    <div class="ticket-home-card">
                        ...
                        <p><?= htmlspecialchars($tiket['deskripsi']); ?></p>
                ...
                <?php while ($bundle = mysqli_fetch_assoc($qBundle)): ?>
                    <div class="promo-card">
                        <div class="promo-thumb">
                            <img src="assets/img/<?= !empty($bundle['gambar']) ? htmlspecialchars($bundle['gambar']) : 'default-promo.jpg'; ?>" alt="<?= htmlspecialchars($bundle['nama_promo']); ?>">
                        ...
                        <div class="promo-body">
                            ...
                            <div class="promo-meta">
                                ...
                                <span>Kode: <?= !empty($bundle['kode']) ? htmlspecialchars($bundle['kode']) : '-'; ?></span>
                            </div>
                        </div>
                    </div>
                <?php endwhile; ?>
